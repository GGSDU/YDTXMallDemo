...
- (void)refreshSelfUI{
    ...
    CGSize size = [titleStr sizeWithFont:self.titleLabel.font constrainedToSize:CGSizeMake(MAXFLOAT, 30)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.backgroundColor = (indexPath.row == self.curIndex)? [UIColor colorWithRed:100 green:200 blue:100 alpha:1] : [UIColor whiteColor];
    return cell;
}
