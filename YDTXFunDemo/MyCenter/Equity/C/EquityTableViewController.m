...
- (void)viewDidLoad {
    ...
    [self.equityTypeArr addObjectsFromArray:@[@"探长合伙人/初级探长",@"探长合伙人/高级探长",@"探长合伙人/荣誉探长",@"塘口合伙人/单塘",@"塘口合伙人/全国",@"活动合伙人/年费型/单人",@"活动合伙人/年费型/家庭",@"活动合伙人/创业型"]];
    [self loadNewData];
}
...
- (void)loadNewData {
    ...
    [self.AFManeger GET:@"http://test.m.yundiaoke.cn/api/partner/ispartner" parameters:param progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
...
#warning Incomplete implementation, return the number of sections
    return self.equityTypeArr.count;
}
