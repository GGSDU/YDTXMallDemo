...
@interface Order_DetailMessageView ()<CallMobileDelegate>
...
//        self.priceBackGroundView.backgroundColor = [UIColor grayColor];
        ...
        [self.goodsImageView sd_setImageWithURL:[NSURL URLWithString:[@"http://" stringByAppendingString:model.images_url]] placeholderImage:[UIImage imageWithContentsOfFile:imagePath]];
...
- (void)btnAction:(UIButton *)sender {
    ...
    self.callMobile = [[CallMobile alloc]initWithFrame:[UIScreen mainScreen].bounds mobileNum:@"13166266570"];
