...
@interface MyOrederGoodsViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyOrederGoodsViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MyOrderGoodsModel *myOrderModel = self.dataSource[indexPath.row];
    ActionShowOrderDetailViewController *actionShowDVC = [[ActionShowOrderDetailViewController alloc]init];
