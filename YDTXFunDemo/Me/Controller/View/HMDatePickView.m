...
- (void)configuration {
    //时间选择器
    UIView *dateBgView = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 320, [UIScreen mainScreen].bounds.size.width, 320)];
    ...
    [commitBtn setTitleColor:[UIColor colorWithRed:0.251 green:0.788 blue:0.941 alpha:1.000] forState:UIControlStateNormal];
    ...
    [cancelBtn setTitleColor:[UIColor colorWithRed:0.251 green:0.788 blue:0.941 alpha:1.000] forState:UIControlStateNormal];
